...
//    }
    ...
    // 해당 유저 알림 전체 조회
    public List<NoticeVO> showAll(Long userNumber) {
    ...
    // 해당 유저 공지 삭제
    public void remove(Long checkNoticeNumber) { checkNoticeDAO.remove(checkNoticeNumber); }

    // 안읽은 알림 전체 개수
    public int notReadTotal(Long userNumber) { return checkNoticeDAO.notReadTotal(userNumber); }

//    // 수정 전 조회
//    public NoticeVO showBeforeModify(Long noticeNumber){ return noticeDAO.find(noticeNumber);}
//    // 수정
